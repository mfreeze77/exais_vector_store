...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--include-content", dest="include_content", action="store_true", default=True)
    parser.add_argument("--no-include-content", dest="include_content", action="store_false")
